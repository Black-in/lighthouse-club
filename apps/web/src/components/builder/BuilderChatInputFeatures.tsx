...
import { ArrowRight, ChevronDown, FileUp, Plus } from 'lucide-react';
...
export default function BuilderChatInputFeatures({
    ...
    const isDisabled = disabled || (!inputValue.trim() && !canSubmit);

    return (
        <div className="relative flex items-center justify-between px-4 pb-2.5 md:px-5 md:pb-3">
            <input
                ref={fileInputRef}
                type="file"
